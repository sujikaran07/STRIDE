...
export const storeProducts = [
    ...
    // --- LORENZO COLLECTION (from public/images/lofan) ---
    {
        id: 301,
        name: "Lorenzo Street",
        price: "$210.00",
    ...
    // --- HELMET HALL COLLECTION (Main Catalog from public root) ---
    {
        id: 201,
        name: "Night Vision",
        price: "$175.00",
